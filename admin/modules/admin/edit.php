                    ...
                    <div class="row">
                        ...
                        <form action = "" method = "POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputEmail3" placeholder="Trần Mạnh Giang" name = "name" value = "<?php echo $EditAdmin['name'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" class="form-control" id="inputEmail3" name = "email" placeholder = "tranmanhgiang06051999@gmail.com" value = "<?php echo $EditAdmin['email'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputEmail3" name = "phone" placeholder = "0395578355" value = "<?php echo $EditAdmin['phone'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputEmail3" name = "address" placeholder = "Hà Nam" value = "<?php echo $EditAdmin['address'] ?>">
