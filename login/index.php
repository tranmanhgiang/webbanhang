...
<body>
    ...
    <div id="formContent">
        ...
        <img src="../public/frontend/images/logo-default.png" id="icon" alt="User Icon" />
        </div>

        <!-- Login Form -->
        <form action = "" method = "POST">
            <input type="email" id="email" class="fadeIn second" name="email" placeholder="Enter email" value = "<?php echo $data['email']; ?>">
